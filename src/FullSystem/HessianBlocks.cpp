...
void FrameFramePrecalc::set(FrameHessian* host, FrameHessian* target, CalibHessian* HCalib )
{
	...
	//这个 leftToLeft 和上面那个 leftToLeft_0 有什么区别吗？
	...
	K(1,2) = HCalib->cyl();
	K(2,2) = 1;
	//这里得到了 先投影到空间 再经过旋转后 之后再投影 一整套的投影的操作
