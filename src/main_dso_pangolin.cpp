...
int main( int argc, char** argv )
{
    ...
    std::thread runthread([&]() {
		...
		//使用实时相机
		int imageNumber = (int)idsToPlay.size();
		if(liveCamera) imageNumber = 10000000;
        for(int ii=0; ii<imageNumber; ii++)
        {
